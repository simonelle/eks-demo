...
spec:
  type: ExternalName
  externalName: usermgmtdb.cfpliqnjlg2j.us-east-1.rds.amazonaws.com
```
 - **Deploy Manifest**
```
...
```
kubectl run -it --rm --image=mysql:5.7.22 --restart=Never mysql-client -- mysql -h usermgmtdb.cfpliqnjlg2j.us-east-1.rds.amazonaws.com -u dbadmin -pdbpassword11
